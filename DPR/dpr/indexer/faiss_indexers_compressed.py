...
class DenseIndexerCompressed(object):
    ...
    def train_quantizer(self, data):
        ...
        if not self.index.is_trained:
            ...
            clustering_index = faiss.index_cpu_to_all_gpus(faiss.IndexFlatL2(768))
...
class DenseFlatIndexerCompressed(DenseIndexerCompressed):
    def __init__(self, vector_sz: int, buffer_size: int = 50000, index_factory_string: str = None):
        super(DenseFlatIndexerCompressed, self).__init__(buffer_size=buffer_size)
...
class DenseHNSWFlatIndexerCompressed(DenseIndexerCompressed):
    """
    ...
    def __init__(self, vector_sz: int, buffer_size: int = 50000, store_n: int = 512
        ...
        super(DenseHNSWFlatIndexerCompressed, self).__init__(buffer_size=buffer_size)
